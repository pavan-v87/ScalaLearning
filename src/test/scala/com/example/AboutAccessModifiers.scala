...
import com.example.support.KoanSuite
import org.scalatest.Matchers

package harkonnen {

  class AlphaBase extends KoanSuite with Matchers {
...
class BetaBase extends AlphaBase with KoanSuite with Matchers {
...
class GammaBase extends KoanSuite with Matchers {
...
class DeltaBase extends AlphaBase with KoanSuite with Matchers {
  val param: AlphaBase = new AlphaBase
...
class EpsilonBase extends KoanSuite with Matchers {
  val param: AlphaBase = new AlphaBase
...
class AboutAccessModifiers extends KoanSuite with Matchers {
